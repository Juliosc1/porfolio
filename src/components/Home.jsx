  ...
  return (
    <div name='home' className='w-full h-screen bg-[#222629]'>
        ...
        <div className={style.homeContainer}>
            ...
            <p className='text-[#8892b0] py-4 max-w-[700px]'>I'm a student on Stockholms Tekniska Institut. Currently i'm focused on finding... Lorem ipsum dolor sit amet consectetur.</p>
            <div>
